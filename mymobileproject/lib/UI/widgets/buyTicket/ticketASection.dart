...
import 'package:flutter/material.dart';
import 'package:mymobileproject/UI/widgets/buyTicket/selectAllButton.dart';
...
import 'package:mymobileproject/UI/widgets/buyTicket/ticketABloc.dart';
import 'package:mymobileproject/UI/widgets/home/bloctitle.dart';
import 'package:mymobileproject/UI/widgets/buyTicket/select_all_button.dart';
import 'package:mymobileproject/constants.dart';
import 'package:mymobileproject/provider/ticket_provider.dart';
...
class _TicketASectionState extends State<TicketASection> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<TicketProvider>(
      builder: (context, ticketProvider, child) {
        final ticketsA = ticketProvider.ticketsA;
        final selectedCount = ticketsA.where((t) => t.isSelected == true).length;
